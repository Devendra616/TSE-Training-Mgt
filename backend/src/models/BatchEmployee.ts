...
export interface BatchEmployeeCreationAttributes extends Optional<
  BatchEmployeeAttributes,
  | "id"
  | "enrollmentStatus"
  | "enrolledAt"
  | "enrolledBy"
 ...
 */
export class BatchEmployee
  extends Model<BatchEmployeeAttributes, BatchEmployeeCreationAttributes>
